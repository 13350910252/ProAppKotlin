...
interface BaseDao<T> {
    ...
    @RawQuery
    fun doFindAll(query: SupportSQLiteQuery?): List<T>?

    @RawQuery
    fun doFind(query: SupportSQLiteQuery?): T

    @RawQuery
    fun doDeleteAll(query: SupportSQLiteQuery?): Int

    @RawQuery
    fun doDeleteByParams(query: SupportSQLiteQuery?): Int

    @RawQuery
    fun doQueryByLimit(query: SupportSQLiteQuery?): List<T>?

    @RawQuery
    fun doQueryByOrder(query: SupportSQLiteQuery?): List<T>?
}