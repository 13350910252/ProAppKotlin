...
class ShapeRelativeLayout : RelativeLayout {
    ...
    private fun init(attrs: AttributeSet?) {
        context.obtainStyledAttributes(attrs, R.styleable.ShapeRelativeLayout).apply {
            oneDrawable = getDrawable(R.styleable.ShapeRelativeLayout_srlOneBg)
            twoDrawable = getDrawable(R.styleable.ShapeRelativeLayout_srlTwoBg)
            val radius = getInteger(R.styleable.ShapeRelativeLayout_srlRadius, 0)
            val leftTopRadius = getInteger(R.styleable.ShapeRelativeLayout_srlLtRadius, 0).toFloat()
            val leftBottomRadius =
                getInteger(R.styleable.ShapeRelativeLayout_srlLbRadius, 0).toFloat()
            val rightTopRadius =
                getInteger(R.styleable.ShapeRelativeLayout_srlRtRadius, 0).toFloat()
            val rightBottomRadius =
                getInteger(R.styleable.ShapeRelativeLayout_srlRbRadius, 0).toFloat()
            mState = getInt(R.styleable.ShapeRelativeLayout_srlState, 0)
            recycle()
            if (mState != 0) {
                setOnClickListener {}
                mIsState = true
